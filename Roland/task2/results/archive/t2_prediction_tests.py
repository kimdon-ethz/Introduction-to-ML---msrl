...
for label in tests:
    ...
    model = SVC(gamma='auto', kernel='rbf', probability=True, class_weight='balanced')
    ...
    # grid_predictions = model_grid.predict_proba(X_test) 
...
print(prediction)
prediction.to_csv('prediction_gridsearch.csv', index=False, float_format='%.3f')